...
public class SwiftOpenVPNFlutterPlugin: NSObject, FlutterPlugin {
    ...
    private static var EVENT_CHANNEL_VPN_STAGE = "top.oneconnect.oneconnect_flutter/vpnstage"
    private static var METHOD_CHANNEL_VPN_CONTROL = "top.oneconnect.oneconnect_flutter/vpncontrol"
