        ...
        body: NestedScrollView(
          ...
          body: ExtendedTabBarView(
            children: List.generate(2, (index) {
              var data = AppConstants.vpnServerList
                  .where((e) => int.parse(e.isFree) == index)
                  .toList();
    ...
    return Container(
      ...
      child: TabBar(
        ...
        indicator: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20)),
        tabs: [Tab(text: 'standard_servers'), Tab(text: 'premium_servers')],
      ),
    );
  }
}
